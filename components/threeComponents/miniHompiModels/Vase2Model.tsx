...
const modelName = "vase2"
const snake_case_name = "vase_2"

const Vase2Model = ({rerender, setRerender ,isMyRoom, initFocused}) => {
        ...
        return (
           ...
           <Indicator 
                position={[
                    ...
                    allModelsStatus[modelName][findFocusedIndex()].position.y +4 * allModelsStatus[modelName][findFocusedIndex()].scale * 2,

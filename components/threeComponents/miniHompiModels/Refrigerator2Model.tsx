...
const modelName = "refrigerator2"
const snake_case_name = "refrigerator_2"

const Refrigerator2Model = ({rerender, setRerender ,isMyRoom, initFocused}) => {
...
export default Refrigerator2Model;
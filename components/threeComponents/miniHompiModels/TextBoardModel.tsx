...
const modelName = "text_board"
const snake_case_name = "text_board"

const TextBoardModel = ({rerender, setRerender ,isMyRoom, initFocused}) => {
        ...
        return (
           ...
           <Indicator 
                position={[
                    ...
                    allModelsStatus[modelName][findFocusedIndex()].position.y +4 * allModelsStatus[modelName][findFocusedIndex()].scale * 4,

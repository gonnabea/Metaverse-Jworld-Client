...
const modelName = "closet1"
const snake_case_name = "closet_1"

const Closet1Model = ({rerender, setRerender ,isMyRoom, initFocused}) => {
        ...
        return (
           ...
           <Indicator 
                position={[
                    ...
                    allModelsStatus[modelName][findFocusedIndex()].position.y + 4 * allModelsStatus[modelName][findFocusedIndex()].scale * 15,

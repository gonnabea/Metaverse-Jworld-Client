...
// let moveNum = 0
const CharacterModel4 = ({ scale, rotation }: CharacterModelOpts) => {


    const characterRef = useRef();

    const gltf = useLoader(GLTFLoader, modelList.character4);
        ...
        return applyConnectedUser().length > 3 ? (
            ...
            <group ref={group}>
                <group  
                    ...
                    ref={characterRef}
                    position={[
                        applyOthersStatus()[2].position.x,
                        applyOthersStatus()[2].position.y,
                        applyOthersStatus()[2].position.z
                    ]}
                    scale={scale} 
                    rotation={[Math.PI / 2, 0, applyOthersStatus()[2].rotateZ]}
    ...
    export default CharacterModel4;